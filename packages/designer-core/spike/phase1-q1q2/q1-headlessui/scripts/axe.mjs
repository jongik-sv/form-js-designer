// axe-core audit for Q1 Headless UI spike.
// Boots the dev server, visits Dialog open / Tabs B active / Popover open states
...
try {
  ...
  await audit('tabs-B-active', async () => {
  ...
  await audit('popover-open', async () => {
