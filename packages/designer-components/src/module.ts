 ...
 * 주입받아 Card/Stack/Button/Tabs/Modal/TabPanel 을 등록한다.
 *
 * TabPanel은 팔레트 숨김 대상:
...
const COMPONENTS = [CardComponent, StackComponent, ButtonComponent, TabsComponent, ModalComponent, TabPanelComponent] as const;
